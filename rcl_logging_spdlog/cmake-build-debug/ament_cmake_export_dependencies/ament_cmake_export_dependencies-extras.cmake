...
set(_exported_dependencies "ament_cmake;rcl_logging_interface;rcutils;spdlog_vendor;spdlog")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(rcl_logging_spdlog_INCLUDE_DIRS "${_include_dirs}")
          endif()
